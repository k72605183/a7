...
<head>
  ...
  <title>Collegiate Cognitive Academy & Advanced Pedagogy Institute — Notebookmerit</title>
  ...
  <link rel="canonical" href="https://notebookmerit.com/">
...
<body>
  ...
  <header class="site-header">
    <div class="header-container">
      <a href="/" class="brand-logo" aria-label="Notebookmerit Home">
        <span class="logo-mark">◈</span>
        <span class="logo-text">Notebookmerit</span>
      </a>
  ...
  <div class="mobile-drawer" id="mobile-drawer" aria-hidden="true">
    <div class="drawer-header">
      <div class="drawer-brand">Notebookmerit</div>
    ...
    <div class="drawer-footer">
      ...
      <p class="drawer-contact-info">Email: concierge@notebookmerit.com</p>
    </div>
  </div>
      ...
      <div style="display: grid; grid-template-columns: 1.15fr 1fr; gap: 4rem; align-items: center;">
        ...
        <div style="position: relative;">
          <div style="border-radius: var(--radius-md); overflow: hidden; box-shadow: var(--shadow-lg); border: 1px solid rgba(11, 25, 44, 0.15); background: #FFFFFF;">
            <img src="/assets/images/campus_students_cohort_discussion.jpg" alt="Collegiate Chemistry Lecture Theatre and Research Colloquium at 181 Mercer Street" style="width: 100%; height: 440px; object-fit: cover;">
    ...
    <div class="container">
      ...
      <div class="grid-2" style="gap: 2.5rem;">
        <div class="card" style="background: #FFFFFF; border-radius: var(--radius-md); overflow: hidden; border: 1px solid #D1DEE8; box-shadow: var(--shadow-sm);">
          <img src="/assets/images/flatlay_study_desk_notebook_laptop.jpg" alt="Bruker Avance NEO 600 MHz High-Field NMR Spectrometer" style="width: 100%; height: 260px; object-fit: cover;">
        ...
        <div class="card" style="background: #FFFFFF; border-radius: var(--radius-md); overflow: hidden; border: 1px solid #D1DEE8; box-shadow: var(--shadow-sm);">
          <img src="/assets/images/student_pencil_exam_study.jpg" alt="Agilent 1290 Infinity II UHPLC Coupled with Triple-Quadrupole Mass Metrology" style="width: 100%; height: 260px; object-fit: cover;">
          <div style="padding: 2rem;">
        ...
        <div class="card" style="background: #FFFFFF; border-radius: var(--radius-md); overflow: hidden; border: 1px solid #D1DEE8; box-shadow: var(--shadow-sm);">
          <img src="/assets/images/stack_of_academic_textbooks.jpg" alt="Rigaku SmartLab Multi-Axis X-Ray Diffractometer" style="width: 100%; height: 260px; object-fit: cover;">
          <div style="padding: 2rem;">
        ...
        <div class="card" style="background: #FFFFFF; border-radius: var(--radius-md); overflow: hidden; border: 1px solid #D1DEE8; box-shadow: var(--shadow-sm);">
          <img src="/assets/images/academic_classroom_study_desks.jpg" alt="Thermo Scientific FE-SEM with Oxford EDX Elemental Mapping" style="width: 100%; height: 260px; object-fit: cover;">
          <div style="padding: 2rem;">
    ...
    <div class="container">
      ...
      <div class="grid-4" style="gap: 2rem;">
        <div class="card" style="border: 1px solid #D1DEE8; border-radius: var(--radius-md); overflow: hidden; background: #FFFFFF; text-align: center;">
          <img src="/assets/images/classroom_teacher_instruction.jpg" alt="Dr. Marcus Sterling, Chair of Physical Chemistry" style="width: 100%; height: 230px; object-fit: cover;">
        ...
        <div class="card" style="border: 1px solid #D1DEE8; border-radius: var(--radius-md); overflow: hidden; background: #FFFFFF; text-align: center;">
          <img src="/assets/images/program_stem_research.jpg" alt="Dr. Helena Thorne, Director of Analytical Spectroscopy" style="width: 100%; height: 230px; object-fit: cover;">
          <div style="padding: 1.5rem;">
        ...
        <div class="card" style="border: 1px solid #D1DEE8; border-radius: var(--radius-md); overflow: hidden; background: #FFFFFF; text-align: center;">
          <img src="/assets/images/hero_academic_campus.jpg" alt="Prof. Arthur Vance, PI in Asymmetric Synthesis" style="width: 100%; height: 230px; object-fit: cover;">
          <div style="padding: 1.5rem;">
        ...
        <div class="card" style="border: 1px solid #D1DEE8; border-radius: var(--radius-md); overflow: hidden; background: #FFFFFF; text-align: center;">
          <img src="/assets/images/pedagogy_collaborative_learning.jpg" alt="Dr. Cynthia Chen, Senior Fellow in Supramolecular Chemistry" style="width: 100%; height: 230px; object-fit: cover;">
          <div style="padding: 1.5rem;">
  ...
  <section class="section section-cleanroom" style="padding: 5.5rem 0; background: #06101E; color: #FFFFFF;">
    <div class="container">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 4rem; align-items: center;">
        ...
        <div>
          <img src="/assets/images/commencement_graduation_celebration.jpg" alt="Exterior facade and collegiate architecture at 181 Mercer Street, New York" style="border-radius: var(--radius-md); width: 100%; height: 420px; object-fit: cover; border: 1px solid rgba(0, 168, 232, 0.3); box-shadow: var(--shadow-lg);">
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-col">
          <div class="footer-brand">◈ Notebookmerit</div>
          <p class="footer-desc">
          ...
          <div class="footer-contact-item"><strong>Concierge:</strong> concierge@notebookmerit.com</div>
        </div>
        <div class="footer-col">
      ...
      <div class="footer-bottom">
        <p>&copy; 2026 Notebookmerit Collegiate Institute. All Rights Reserved. Academic research at 181 Mercer Street, New York, NY 10012.</p>
